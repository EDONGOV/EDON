...
SECRET_PATTERNS = [
    ...
    re.compile(r"(?i)\b(?:ANTHROPIC_API_KEY|EDON_API_TOKEN|CLERK_SECRET_KEY|STRIPE_SECRET_KEY|TELEGRAM_BOT_TOKEN|GITHUB_TOKEN|NPM_TOKEN|PYPI_TOKEN|TWINE_PASSWORD|EDON_BOOTSTRAP_SECRET|EDON_DB_ENCRYPTION_KEY)\s*=\s*([^#\s]+)"),
]
